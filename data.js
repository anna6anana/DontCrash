...
const ROAD_RULES = [
  ...
  { q: "If you plan to pass another vehicle, you should:", options: ["Not assume the other driver will make space for you to return to your lane", "Assume the other driver will let you pass if you use your turn signal", "Assume the other driver will maintain a constant speed", "Look in your mirror for 12 seconds then proceed"], answer: 0 },
